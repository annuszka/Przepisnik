...
namespace Przepisnik.Controllers
{
    public class RecipeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecipeID,Title,RecipePhotoUrl,AddingDate,Description,Ingredients,Preparation,PrepTime,Portions,Source,IfPublic,UserId,AverageRating")] Recipe recipe)
        {
